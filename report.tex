...
\end{colorboxed}
\begin{colorboxed}{Code}{\texttt{user/sleep.c}\hspace{0.29\textwidth}\textbf{Code: }\texttt{kernel/sysproc.c::sys\_sleep()}}{unbreakable}
\begin{minipage}[t]{0.4\textwidth}
    \inputminted[baselinestretch=0.75,firstline=10]{c}{user/sleep.c}
\end{minipage}
\hfill\vline\hfill
\begin{minipage}[t]{0.5\textwidth}
    \inputminted[baselinestretch=0.75,firstline=45,lastline=63]{c}{kernel/sysproc.c}
\end{minipage}
\end{colorboxed}
\section{C3}
\begin{colorboxed}{Execution Trace}{\texttt{sleep}}{breakable}
    \inputminted[baselinestretch=0.75]{text}{assets/gdb-trace.txt}
\end{colorboxed}
\section{C4}
\begin{figure}[H]
    \centering
